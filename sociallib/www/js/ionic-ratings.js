  ...
  function ionicRatings () {
    return {
      ...
      scope: {
        ...
        ratingsObjId: '=ratingsobjid',
        ratingsValue: '=ratingsvalue'
        //currRating: scope.rating
      },
      link: function(scope, element, attrs) {
        ...
        //scope.rating = 0;
        if (scope.ratingsValue) {
          scope.rating = scope.ratingsValue;
        }
        ...
        scope.ratingsClicked = function(val) {
          ...
          scope.ratingsObj.callback(scope.rating,scope.ratingsObjId);
        };
