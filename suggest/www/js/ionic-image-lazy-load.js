    ...
    function ($document, $timeout, $ionicScrollDelegate, $compile) {
        return {
            ...
            link: function ($scope, $element, $attributes) {
                ...
                if (($attributes.imageLazyLoader)&&($attributes.imageBroken!='')) {
                    var loader = $compile('<div class="'+$attributes.loaderClass+'"><ion-spinner class="image-loader" icon="' + $attributes.imageLazyLoader + '"></ion-spinner></div>')($scope);
